            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    {consultants.map((consultant) => (
                        ...
                        >
                            <div className="glass rounded-xl overflow-hidden backdrop-blur-xl group h-full flex flex-col">
                                {/* Avatar */}
                                <div className="h-40 sm:h-48 relative overflow-hidden flex items-center justify-center bg-slate-300 dark:bg-slate-700 flex-shrink-0">
                                    <motion.img
                                ...
                                <div className="p-4 sm:p-6 flex flex-col grow">
                                    ...
                                    <div className="flex items-center justify-between gap-2 mt-auto">
                                        ...
                                        <motion.button
                                            whileHover={{ scale: 1.1 }}
                                            whileTap={{ scale: 0.9 }}
                                            className="p-1.5 sm:p-2 rounded-full bg-gradient-to-r from-teal-600 to-green-600 text-white hover:shadow-lg transition-shadow flex-shrink-0"
                                        >
                                            <FiMail size={14} />
                                        </motion.button>
                                    </div>
